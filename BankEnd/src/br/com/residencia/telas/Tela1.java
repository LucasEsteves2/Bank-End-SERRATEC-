...
public class Tela1 extends JFrame {
	...
	public Tela1(Connection con) {
		...
		btnAcessar.setIcon(new ImageIcon(Tela1.class.getResource("/br/com/residencia/imagens/cadeado-aberto (4).png")));
		btnAcessar.setBounds(1145, 434, 121, 44);
		contentPane.add(btnAcessar);

		JLabel imgCadeado = new JLabel("");
		imgCadeado.setIcon(new ImageIcon(Tela1.class.getResource("/br/com/residencia/imagens/cadeado-trancado.png")));
		...
		lblCadastrarNovo.setIcon(new ImageIcon(Tela1.class
				.getResource("/br/com/residencia/imagens/calendar_clock_schedule_icon-icons.com_51085.png")));
		...
		lblfundoTransparente
				.setIcon(new ImageIcon(Tela1.class.getResource("/br/com/residencia/imagens/FUNDO PRA TELA.png")));
