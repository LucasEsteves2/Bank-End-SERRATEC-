...
public class Deposito extends JFrame {
	...
	public Deposito(Connection conexao, Contas contaRemetenteV) {
		...
		btnAmarelo.setIcon(new ImageIcon(Deposito.class.getResource("/br/com/residencia/bankend/imagens/atencao.png")));
		...
		btnVerde.setIcon(new ImageIcon(Deposito.class.getResource("/br/com/residencia/bankend/imagens/marca-de-verificacao (2).png")));
		...
		btnVermelho.setIcon(new ImageIcon(Deposito.class.getResource("/br/com/residencia/bankend/imagens/cancelar2.png")));
...
//aaa
		...
		btnVermelho.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Deposito reabrir = new Deposito(conexao, contaRemetente);
